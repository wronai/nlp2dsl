...
class TestRegistryStructure:
    ...
    def test_registry_entry_has_required_keys(self, action_name):
...
class TestAliasResolution:
    ...
    def test_alias_best_match(self):
...
class TestHelperFunctions:
    ...
    def test_get_required_fields_invoice(self):
    ...
    def test_get_defaults_invoice(self):
...
class TestCategories:
    ...
    def test_business_actions_nonempty(self):
...
class TestCompositeIntents:
    ...
    def test_composite_actions_exist(self, composite_name):

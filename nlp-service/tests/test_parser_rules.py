...
class TestParseInvoice:
    ...
    def test_parse_invoice_simple(self):
    ...
    def test_parse_invoice_missing_data(self):
    ...
    def test_parse_invoice_eur(self):
    ...
    def test_parse_invoice_usd(self):
...
class TestParseEmail:
    ...
    def test_parse_email_english(self):
...
class TestParseReport:
    ...
    def test_parse_report_weekly(self):
    ...
    def test_parse_report_finance_csv(self):
...
class TestParseComposite:
    ...
    def test_parse_composite_invoice_notify(self):
    ...
    def test_parse_composite_full_flow(self):
...
class TestParseSystem:
    ...
    def test_parse_system_help(self):
...
class TestAmountExtraction:
    ...
    def test_parse_amount_extraction(self, text, expected_amount, expected_currency):
...
class TestTriggerDetection:
    ...
    def test_parse_trigger_detection(self, text, expected_trigger):
...
class TestResultStructure:
    ...
    def test_result_is_nlp_result(self):
